CLASS zcl_ce_rap_agency_darro2017 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zz_travel_agency_es5431f749132-agencyid.
    TYPES t_business_data TYPE TABLE OF zz_travel_agency_es5431f749132.
...
CLASS zcl_ce_rap_agency_darro2017 IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_DARRO2017' ).
